...
public class ShotGunFighter : MonoBehaviour
{
	...
	[SerializeField] Transform firePoint2; // 弾の発射位置
	[SerializeField] Transform firePoint3; // 弾の発射位置
	[SerializeField] Transform firePoint4; // 弾の発射位置
	[SerializeField] Transform firePoint5; // 弾の発射位置
	...
	private void Shoot()
	{
		if (bulletPrefab != null && firePoint != null)
		{
			...
			GameObject bulletInstance2 = Instantiate(bulletPrefab, firePoint2.position, firePoint2.rotation);
			GameObject bulletInstance3 = Instantiate(bulletPrefab, firePoint3.position, firePoint3.rotation);
			GameObject bulletInstance4 = Instantiate(bulletPrefab, firePoint4.position, firePoint4.rotation);
			GameObject bulletInstance5 = Instantiate(bulletPrefab, firePoint5.position, firePoint5.rotation);
